...
namespace Alba.Jaml.MSInternal
{
    internal abstract class XamlName
    {
        ...
        public string Name { [TargetedPatchingOptOut ("PERF")] get; [CompilerGenerated] protected set; }

        public string Namespace
        {
            [TargetedPatchingOptOut ("PERF")] get { return this._namespace; }
        }

        public string Prefix
        {
            [TargetedPatchingOptOut ("PERF")] get { return this._prefix; }
        }
