    ...
    internal class MePullParser
    {
        ...
        private void SetBrokenRuleString (string ruleString)
        {
            if (string.IsNullOrEmpty(this._brokenRule)) {
                this._brokenRule = SR.Get("UnexpectedToken", new object[] { this._tokenizer.Token, ruleString, this._originalText });
            }
        }

        private int LineNumber
        {
            get { return this._tokenizer.LineNumber; }
        }

        private int LinePosition
        {
            get { return this._tokenizer.LinePosition; }
        }
