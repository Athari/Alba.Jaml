...
//            }
        ...
        internal XamlTypeName GetXamlTypeName (XamlName typeName)
        {
            ...
            if (xamlNamespace == null) {
                throw new XamlParseException(SR.Get("PrefixNotFound", new object[] { typeName.Prefix }));
            }
            return new XamlTypeName(xamlNamespace, typeName.Name);
        }

        private XamlType GetXamlTypeOrUnknown (System.Xaml.Schema.XamlTypeName typeName)
        {
            return this.GetXamlType(XamlTypeName.From(typeName), true);
        }
        ...
        {
            [TargetedPatchingOptOut ("PERF")] get { return this._localAssembly; }
            [TargetedPatchingOptOut ("PERF")] protected set { this._localAssembly = value; }
        }
        ...
        {
            [TargetedPatchingOptOut ("PERF")] get { return this._schemaContext; }
        }
    }
}