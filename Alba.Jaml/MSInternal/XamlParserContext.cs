...
//            return member.IsReadVisibleTo(this.LocalAssembly, accessingType);
        ...
        public bool AllowProtectedMembersOnRoot { [TargetedPatchingOptOut ("PERF")] get; [TargetedPatchingOptOut ("PERF")] set; }

        public int CurrentArgCount
        {
            get { return this._stack.CurrentFrame.CtorArgCount; }
            set { this._stack.CurrentFrame.CtorArgCount = value; }
        }

        public bool CurrentForcedToUseConstructor
        {
            get { return this._stack.CurrentFrame.ForcedToUseConstructor; }
            set { this._stack.CurrentFrame.ForcedToUseConstructor = value; }
        }

        public bool CurrentInCollectionFromMember
        {
            get { return this._stack.CurrentFrame.InCollectionFromMember; }
            set { this._stack.CurrentFrame.InCollectionFromMember = value; }
        }

        public bool CurrentInContainerDirective
        {
            get { return this._stack.CurrentFrame.InContainerDirective; }
            set { this._stack.CurrentFrame.InContainerDirective = value; }
        }

        public bool CurrentInImplicitArray
        {
            get { return this._stack.CurrentFrame.InImplicitArray; }
            set { this._stack.CurrentFrame.InImplicitArray = value; }
        }

        public bool CurrentInInitProperty
        {
            get { return (this._stack.CurrentFrame.Member == XamlLanguage.Initialization); }
        }

        public bool CurrentInItemsProperty
        {
            get { return (this._stack.CurrentFrame.Member == XamlLanguage.Items); }
        }

        public bool CurrentInUnknownContent
        {
            get { return (this._stack.CurrentFrame.Member == XamlLanguage.UnknownContent); }
        }

        public XamlMember CurrentMember
        {
            get { return this._stack.CurrentFrame.Member; }
            set { this._stack.CurrentFrame.Member = value; }
        }

        public XamlType CurrentPreviousChildType
        {
            get { return this._stack.CurrentFrame.PreviousChildType; }
            set { this._stack.CurrentFrame.PreviousChildType = value; }
        }

        public XamlType CurrentType
        {
            get { return this._stack.CurrentFrame.XamlType; }
            set { this._stack.CurrentFrame.XamlType = value; }
        }

        public bool CurrentTypeIsRoot
        {
            get { return ((this._stack.CurrentFrame.XamlType != null) && (this._stack.Depth == 1)); }
        }

        public string CurrentTypeNamespace
        {
            get { return this._stack.CurrentFrame.TypeNamespace; }
            set { this._stack.CurrentFrame.TypeNamespace = value; }
        }

        public Func<string, string> XmlNamespaceResolver { [TargetedPatchingOptOut ("PERF")] get; [TargetedPatchingOptOut ("PERF")] set; }
    }
}