...
namespace Alba.Jaml.MSInternal
{
    internal class XamlContextStack<T> where T : XamlFrame
    {
        ...
        {
            [TargetedPatchingOptOut ("PERF")] get { return this._currentFrame; }
        }

        public int Depth
        {
            [TargetedPatchingOptOut ("PERF")] get { return this._depth; }
            [TargetedPatchingOptOut ("PERF")] set { this._depth = value; }
        }
        ...
        {
            get { return (T)this._currentFrame.Previous; }
        }

        public T PreviousPreviousFrame
        {
            get { return (T)this._currentFrame.Previous.Previous; }
        }
    }
}